...
OUT14="$OUT_DIR/results_size14.csv"

RATIOS=("1:1" "1:2" "2:1")

# Budgets
BUDGETS_14=(500 1000 1500 2500 3000 3500)
...
# Vérification
if ! java -cp "$CLASS_PATH" "$MAIN_CLASS" 14 1 1:1 500 500 "$ALGO_RED" "$ALGO_BLUE" "$START_COLOR" >/dev/null 2>&1; then
